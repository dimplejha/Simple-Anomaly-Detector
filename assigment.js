...
//         // Ignore anomalies for the Serial fact
//         if (factName === 'Serial') {
//             return;
//         }
//         const values = Object.keys(factValues[factName]);
//         if (values.length > 1) {
//             // More than one unique value indicates a potential anomaly
//             values.forEach(value => {
//                 const machines = factValues[factName][value];
//                 if (machines.length < Object.keys(factData).length) {
//                     anomalies.push({
//                         fact: factName,
//                         value: value,
//                         machines: machines
...
//             console.log(`Fact: ${anomaly.fact}, Value: ${anomaly.value}, Machines: ${anomaly.machines.join(', ')}`);
//         });
//     } else {
